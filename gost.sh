...
function Install_ct() {
  ...
  if [[ ${addyn} == [Yy] ]]; then
    ...
    mkdir /etc/gost && wget --no-check-certificate https://ws.bxcc.de/https://raw.githubusercontent.com/sjhxlll/Multi-EasyGost/master/config.json && mv config.json /etc/gost && chmod -R 777 /etc/gost
  fi
